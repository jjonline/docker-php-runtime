...
* User: `www-data`
* php: 5.6/7.1/7.2/7.4/8.0/8.1/8.2/8.3
* nginx
* supervisor
* php-fpm
...
| php7.1-fpm-alpine        | Latest PHP7.1 | 3.10           | recommended to use   |
| php7.1-fpm-alpine-vx.y.z | Latest PHP7.1 | 3.10           | with git release tag |
